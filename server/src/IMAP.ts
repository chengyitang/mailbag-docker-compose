...
export class Worker {
  ...
  constructor(inServerInfo: IServerInfo) {
    ...
    Worker.serverInfo.imap.auth.user = process.env.IMAP_USER || Worker.serverInfo.imap.auth.user;
    Worker.serverInfo.imap.auth.pass = process.env.IMAP_PASS || Worker.serverInfo.imap.auth.pass;
